          ...
          <v-row>
            <v-col cols="12">
              <v-text-field required label ="E-mail" 
                v-model="loginForm.email"></v-text-field>
            </v-col>
            <v-col cols="12">
              <v-text-field
                label="Password"
          ...
          <v-row>
            <v-col cols="12">
              <v-text-field required label ="first name" 
                v-model="registerForm.firstName"></v-text-field>
            </v-col>
            <v-col cols="12">
              <v-text-field required label ="last name" 
                v-model="registerForm.lastName"></v-text-field>
            </v-col>
